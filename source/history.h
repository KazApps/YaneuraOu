...
inline int cavalry_index(const Position& pos) {
    return pos.cavalry_key() & (UINT_16_HISTORY_SIZE - 1);
}
...
enum CorrHistType {
    ...
    Cavalry,       // By color and positions of cavalry pieces (major pieces, Knight)
