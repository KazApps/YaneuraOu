TUNE(SetRange(-50, 50), xx13,xx14,xx15,xx16)
...
int correction_value(const YaneuraOuWorker& w, const Position& pos, const Stack* const ss) {
    ...
    return xx1 * pcv + xx2 * micv + xx3 * (wnpcv + bnpcv) + xx4 * cntcv;
}
...
void update_correction_history(const Position&          pos,
    ...
    workerThread.minorPieceCorrectionHistory[minor_piece_index(pos)][us] << bonus * xx6 / 128;
    ...
    if (m.is_ok())
    {
        ...
        (*(ss - 2)->continuationCorrectionHistory)[pc][to] << bonus * xx7 / 128;
        (*(ss - 4)->continuationCorrectionHistory)[pc][to] << bonus * xx8 / 128;
    }
}
...
void YaneuraOuWorker::clear() {
    ...
    mainHistory.fill(xx10);
    captureHistory.fill(xx11);
    pawnHistory.fill(xx12);
    pawnCorrectionHistory.fill(xx13);
    minorPieceCorrectionHistory.fill(xx14);
    nonPawnCorrectionHistory.fill(xx15);
    ...
    for (size_t i = 1; i < reductions.size(); ++i)
        reductions[i] = int(xx18 / 128.0 * std::log(i));
...
Value YaneuraOuWorker::search(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode)
{
	...
	*/
    ...
    {
        int evalDiff = std::clamp(-int((ss - 1)->staticEval + ss->staticEval), xx19, xx20) + xx21;
        mainHistory[~us][((ss - 1)->currentMove).raw()] << evalDiff * xx22;
        if (!ttHit && type_of(pos.piece_on(prevSq)) != PAWN
            && ((ss - 1)->currentMove).type_of() != PROMOTION)
            pawnHistory[pawn_history_index(pos)][pos.piece_on(prevSq)][prevSq] << evalDiff * xx23;
    }
	...
	*/
    ...
    if (priorReduction >= 3 && !opponentWorsening)
        depth++;
    if (priorReduction >= 2 && depth >= 2 && ss->staticEval + (ss - 1)->staticEval > xx24)
        depth--;
    ...
    if (!PvNode && eval < alpha - xx25 - xx26 * depth * depth)
	...
	*/

    {
		...
		auto futility_margin = [&](Depth d) {
            Value futilityMult = xx27 - xx28 * !ss->ttHit;

            return futilityMult * d                                //
                 - xx29 * improving * futilityMult / 1024          //
                 - xx30 * opponentWorsening * futilityMult / 4096  //
                 + std::abs(correctionValue) / xx31;
        };
    ...
    if (cutNode && ss->staticEval >= beta - xx32 * depth + xx33 && !excludedMove
#if STOCKFISH
	...
	// probCutに使うbeta値。
	probCutBeta = beta + xx34 - xx35 * improving;
        ...
        && !(is_valid(ttData.value) && ttData.value < probCutBeta))
    {
		...
		Depth      probCutDepth = std::clamp(depth - 5 - (ss->staticEval - beta) / xx36, 0, depth);
...
// 🤔 Stockfish本家のこの読み筋の出力、細かすぎるので時間をロスする。しないほうがいいと思う。
            ...
            && !is_loss(bestValue))
        {
            ...
            if (capture || givesCheck)
            {
                ...
                if (!givesCheck && lmrDepth < 7)
                {
					...
					Value futilityValue = ss->staticEval + xx39 + xx40 * lmrDepth
										+ PieceValue[capturedPiece] + xx41 * captHist / 1024;
                ...
                int margin = std::max(xx42 * depth + captHist / xx43, 0);
#if STOCKFISH
            ...
            else
            {
                ...
                if (history < xx44 * depth)
                    continue;

                history += xx45 * mainHistory[us][move.raw()] / 32;

				// (*Scaler): Generally, lower divisors scales well
				// 一般に、割る数（divisor）が小さいほどスケールしやすい。

				lmrDepth += history / xx46;

				Value futilityValue = ss->staticEval + xx47 + xx48 * !bestMove + xx49 * lmrDepth
                    + xx50 * (ss->staticEval > alpha);
				...
				*/
                ...
                if (!pos.see_ge(move, xx51 * lmrDepth * lmrDepth))
                    continue;
            }
        }
		...
		*/
            ...
            && ttData.depth >= depth - 3)
        {
			...
			*/
            ...
            Value singularBeta  = ttData.value - (xx52 + xx53 * (ss->ttPv && !PvNode)) * depth / xx54;
            ...
            {
                int corrValAdj   = std::abs(correctionValue) / xx55;
                int doubleMargin = xx56 + xx57 * PvNode - xx58 * !ttCapture - corrValAdj
                                 - xx59 * ttMoveHistory / xx60 - (ss->ply > rootDepth) * xx61;
                int tripleMargin = xx62 + xx63 * PvNode - xx64 * !ttCapture + xx65 * ss->ttPv - corrValAdj
                                 - (ss->ply * 2 > rootDepth * 3) * xx66;
			...
			*/
            ...
            {
                ttMoveHistory << std::max(xx67 - xx68 * depth, xx69);
                return value;
            }
		...
		if (ss->ttPv)
            r -= xx70 + PvNode * xx71 + (ttData.value > alpha) * xx72
               + (ttData.depth >= depth) * (xx73 + cutNode * xx74);

        // These reduction adjustments have no proven non-linear scaling
        // これらの減少量調整には、非線形スケーリングの有効性が証明されていません

        r += xx75;  // Base reduction offset to compensate for other tweaks
				   // 他の調整を補正するための基準リダクションオフセット

		r -= moveCount * xx76;
        r -= std::abs(correctionValue) / xx77;
		...
		*/
        ...
        if (capture)
            ss->statScore = xx84 * int(PieceValue[pos.captured_piece()]) / 128
		...
		*/
        ...
        if (depth >= 2 && moveCount > 1)
        {
			...
			*/
            ...
            if (value > alpha)
            {
                ...
                const bool doDeeperSearch = d < newDepth && value > (bestValue + xx86 + 2 * newDepth);
                const bool doShallowerSearch = value < bestValue + xx87;
                ...
                update_continuation_histories(ss, movedPiece, move.to_sq(), xx88);
            }
            else if (value > alpha && value < bestValue + xx89)
                newDepth--;
        }
        ...
        else if (!PvNode || moveCount > 1)
        {
			...
			value = -search<NonPV>(pos, ss + 1, -(alpha + 1), -alpha,
                                   newDepth - (r > xx91) - (r > xx92 && newDepth > 2), !cutNode);
		}
	...
	else if (bestMove)
    {
        ...
        if (!PvNode)
            ttMoveHistory << (bestMove == ttData.move ? xx93 : xx94);
    }
	...
	*/
    ...
    {
        int bonusScale = xx95;
        bonusScale -= (ss - 1)->statScore / xx96;
        bonusScale += std::min(xx97 * depth, xx98);
        bonusScale += xx99 * ((ss - 1)->moveCount > 8);
        bonusScale += xx100 * (!ss->inCheck && bestValue <= ss->staticEval - xx101);
        bonusScale += xx102 * (!(ss - 1)->inCheck && bestValue <= -(ss - 1)->staticEval - xx103);

        bonusScale = std::max(bonusScale, 0);

        const int scaledBonus = std::min(xx104 * depth - xx105, xx106) * bonusScale;

        update_continuation_histories(ss - 1, pos.piece_on(prevSq), prevSq,
                                      scaledBonus * xx107 / 32768);

        mainHistory[~us][((ss - 1)->currentMove).raw()] << scaledBonus * xx108 / 32768;

		// TODO : これで合ってるか？あとで検証する。
        if (type_of(pos.piece_on(prevSq)) != PAWN && ((ss - 1)->currentMove).type_of() != PROMOTION)
            pawnHistory[pawn_history_index(pos)][pos.piece_on(prevSq)][prevSq]
              << scaledBonus * xx109 / 32768;
    }
    ...
    else if (priorCapture && prevSq != SQ_NONE)
    {
        ...
        captureHistory[pos.piece_on(prevSq)][prevSq][type_of(capturedPiece)] << xx110;
    }
	...
	*/
    ...
    else
    {
		...
		*/ 
		...
		futilityBase = ss->staticEval + xx111;
...
Depth Search::YaneuraOuWorker::reduction(bool i, Depth d, int mn, int delta) const {
    ...
    return reductionScale - delta * xx112 / rootDelta + !i * reductionScale * xx113 / 512 + xx114;
}
...
void update_all_stats(const Position&          pos,
	...
	int bonus = std::min(xx115 * depth - xx116, xx117) + xx118 * (bestMove == ttMove);
	int malus = std::min(xx119 * depth - xx120, xx121) - xx122 * moveCount;
	...
	*/
    ...
    {
        update_quiet_histories(pos, ss, workerThread, bestMove, bonus * xx123 / 1024);

        // Decrease stats for all non-best quiet moves
        // 最善でないquietの指し手すべての統計を減少させる

        for (Move move : quietsSearched)
            update_quiet_histories(pos, ss, workerThread, move, -malus * xx124 / 1024);
    }
    else
    {
        ...
        captureHistory[movedPiece][bestMove.to_sq()][capturedPiece] << bonus * xx125 / 1024;
    }
    ...
    if (prevSq != SQ_NONE && ((ss - 1)->moveCount == 1 + (ss - 1)->ttHit) && !pos.captured_piece())
        update_continuation_histories(ss - 1, pos.piece_on(prevSq), prevSq, -malus * xx126 / 1024);
    ...
    for (Move move : capturesSearched)
    {
		...
		*/
        ...
        captureHistory[movedPiece][move.to_sq()][capturedPiece] << -malus * xx127 / 1024;
    }
}
...
void update_continuation_histories(Stack* ss, Piece pc, Square to, int bonus) {
    std::array<ConthistBonus, 6> conthist_bonuses = {
      {{1, xx128}, {2, xx129}, {3, xx130}, {4, xx131}, {5, xx132}, {6, xx133}}};
    ...
    for (const auto [i, weight] : conthist_bonuses)
    {
        ...
        if (((ss - i)->currentMove).is_ok())
            (*(ss - i)->continuationHistory)[pc][to] << (bonus * weight / 1024) + xx134 * (i < 2);
    }
}
...
void update_quiet_histories(
  const Position& pos, Stack* ss, Search::YaneuraOuWorker& workerThread, Move move, int bonus) {
    ...
    if (ss->ply < LOW_PLY_HISTORY_SIZE)
        workerThread.lowPlyHistory[ss->ply][move.raw()] << bonus * xx135 / 1024;

    update_continuation_histories(ss, pos.moved_piece(move), move.to_sq(), bonus * xx136 / 1024);

    int pIndex = pawn_history_index(pos);
    workerThread.pawnHistory[pIndex][pos.moved_piece(move)][move.to_sq()]
      << bonus * (bonus > 0 ? xx137 : xx138) / 1024;
}
